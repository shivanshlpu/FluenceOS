...
from app.routers import auth, speaking, knowledge, dashboard, tracker, cv, roadmap, market
...
app.include_router(market.router, prefix="/api/java/market", tags=["Job Market (Java Compat)"])
